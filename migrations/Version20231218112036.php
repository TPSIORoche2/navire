 ...
 */
final class Version20231218112036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX ind_INDICATIF ON port (indicatif)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX ind_INDICATIF ON port');
    }
}
